...
/** @file
 *  Provides an APSTA functionality specific to the 43012
 */
...
#define AMPDU_AP_DEFAULT_BA_WSIZE   8   /* AP default BA window size */
...
{
    return wwd_wifi_set_ampdu_parameters_common( WWD_STA_INTERFACE, AMPDU_STA_DEFAULT_BA_WSIZE, AMPDU_MPDU_AUTO, AMPDU_RX_FACTOR_64K );
}
